...
class Networkx_to_PyG(InMemoryDataset):
    def __init__(self, nx_graph, node_order, parameters, transform=None, pre_transform=None):
        self.nx_graph = nx_graph
        self.node_order = node_order
        self.parameters = parameters
        super().__init__('.', transform, pre_transform)
        self.data, self.slices = self.process_graph()
    ...
    def process_graph(self):
        ...
        return self.collate([data])  # Wrap in slices for InMemoryDataset
