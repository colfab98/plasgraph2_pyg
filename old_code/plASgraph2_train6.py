...
import architecture
import old_code.create_graph7 as create_graph7
import config
import thresholds
...
def main(config_file: 'YAML configuration file',
    ...
    if os.path.exists(cache_path):
        ...
        G = create_graph7.read_graph_set(file_prefix, train_file_list,
        ...
        all_graphs = create_graph7.Networkx_to_PyG(model_output_dir, G, node_list, parameters)
